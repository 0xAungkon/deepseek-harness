 ...
 *
 * NOTE: When trustedHosts is non-empty, these methods are accessible to
 * trusted hosts (not just loopback). This allows LAN access when explicitly
 * configured via --host 0.0.0.0.
 */
